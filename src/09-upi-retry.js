...
export function upiRetry(outcomes) {
  ...
  let totalWaitTime = 0 , i =0 , success = false , attempts=0 , failedAttempts = 0 ;
  do {
    ...
    return { attempts: attempts, success: success, totalWaitTime: totalWaitTime }
